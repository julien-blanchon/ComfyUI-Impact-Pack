...
class MaskDetailerPipe:
    ...
    def doit(self, image, mask, basic_pipe, guide_size, guide_size_for, max_size, mask_mode,
             ...
             feather, crop_factor, drop_size, refiner_ratio=None, refiner_basic_pipe_opt=None, detailer_hook=None):
        ...
        enhanced_img, _, cropped_enhanced, cropped_enhanced_alpha, _ = \
            DetailerForEach.do_detail(image, segs, model, clip, vae, guide_size, guide_size_for, max_size, seed, steps,
                                      ...
                                      force_inpaint=True, wildcard=None, detailer_hook=detailer_hook,
        ...
        return enhanced_img, cropped_enhanced, cropped_enhanced_alpha, basic_pipe, refiner_basic_pipe_opt
